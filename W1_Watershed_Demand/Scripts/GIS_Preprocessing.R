...
outputResults <- function (ws, WS_pod_points_Merge, wsBound_OneMile_Intersect, wsBound_Inner_Intersect, wsMention, wsBound_Outside_HalfMile_Intersect) {
  ...
  writeData(wb, "R_Review",
            allDF %>%
              ...
              mutate(REPORT_SOURCE = NA, REPORT_TRIBUTARY = NA, 
                     REPORT_LATITUDE = NA, REPORT_LONGITUDE = NA, LAT_LON_CRS = NA,
                     REPORT_NORTHING = NA, REPORT_EASTING = NA, NOR_EAS_CRS = NA,
                     REPORT_TOWNSHIP = NA, REPORT_RANGE = NA, REPORT_DATUM = NA,
                     REPORT_SECTION = NA, REPORT_Q_SECTION = NA, REPORT_QQ_SECTION = NA, 
                     REPORT_SECTION_CORNER = NA, 
                     REPORT_NS_MOVE_FT = NA, REPORT_NS_DIRECTION = NA, REPORT_EW_MOVE_FT = NA, REPORT_EW_DIRECTION = NA,
                     MULTI_OPTIONS_CHOICE = NA_integer_, NOTES2 = "--") %>%
