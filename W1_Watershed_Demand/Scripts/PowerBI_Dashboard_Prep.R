...
mainProcedure <- function () {
  ...
  wsBound <- getGIS(ws = ws, 
    ...
    mutate(WATERSHED = ws$NAME, SDA_ID = ws$ID) %>%
    select(SDA_ID, WATERSHED) %>%
    st_transform(st_crs(assignedDF))
  ...
  htmlVec <- c("<!DOCTYPE html>",
               ...
               paste0("<p>", 
                      paste0("This GIS dataset includes a comprehensive set of ",
                             ...
                             "Water Board’s Supply & Demand Assessment Section (SDA)."),
                      "</p>"),
               "",
               # Description
               "<h2>Description</h2>",
               ...
               paste0("<ol>",
                      ...
                      paste0("<li>",
                             ...
                             "In the SDA hydrologic modeling procedure, this data is ",
                             "modified, and one major flowline is assigned to each ",
                             "catchment in the watershed.",
                             "</li>"),
                      paste0("<li>",
                             "<b>HUC-12 Subbasins</b>: ",
                             "Subdivisions from the National Map Hydrologic Unit ",
                             "Code (HUC) dataset that enable a more granular ",
                             "regional analysis within a watershed. Wherever ",
                             "applicable, the HUC-12 subbasins are clipped to ",
                             "the extent of the California land mass (using a ",
                             "<a href='https://geodata.library.ucsb.edu/catalog/3853-s3_2002_s3_reg_pacific_ocean'>",
                             "polygon of the Pacific Ocean</a> prepared by Santa Barbara County).",
                             "</li>"),
                      paste0("<li>",
                             "<b>NHD Catchments</b>: ",
                      ...
                      paste0("<li>",
                             ...
                             "polygon is derived from the official National Map HUC boundaries ",
