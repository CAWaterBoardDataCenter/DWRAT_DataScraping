...
# Then, using Anaconda, this script executes its Python counterpart (LSPC_010b),
...
mainProcedure <- function () {
  ...
  cat("\n\n")
  cat("Starting 'LSPC_010a_Stage_Climate_Data.R'!\n")
  ...
  scriptPath <- "W3_LSPC_Watershed/scripts/LSPC_010b_Stage_Climate_Data.py" |>
  ...
  cat(col_green("\n'LSPC_010a_Stage_Climate_Data.R' is complete!\n\n"))
