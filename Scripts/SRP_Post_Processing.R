...
gag <- subset(gag, Date>= "2023-05-01" & Date <= "2023-05-31")
date_seq = gag$Date
...
rm(list = ls(pattern = "sub"), gag_list)
...
write.csv(SRP_monthly, here("ProcessedData/SRP_2023-05_MK.csv"), row.names = FALSE)
