...
# Last Updated: By Payman Alemi on 2/3/2026
...
# Include flagging and remediation blocks in Dat_PRMS.R and Dat_SRP.R? 
#  Set to TRUE or FALSE after consulting with SDU management for that month's runs. TRUE means
# that the flagging and remediation code blocks in the Dat_PRMS.R and Dat_SRP.R script will be executed. FALSE
...
EndDate <- as.Date("2026-01-31")# set to desired end date for observed meteorological data range
