...
# The Russian River Workflow procedure is intended to be run from the Supply
# project in SDA's DWRAT_DataScraping repository


if (!grepl("DWRAT_DataScraping/Supply$",
