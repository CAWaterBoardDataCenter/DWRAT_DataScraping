...
removeDups <- function (inputDF, unitsQAQC, i, wsID) {
  ...
  for (j in 1:length(yearVec)) {
    ...
    # The procedure originally made removals separately based on DIVERISON_TYPE
    # The original code is still here
    
    # NOTE: A vector of relevant use types was also needed for this loop
